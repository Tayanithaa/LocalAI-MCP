"""
OAuth handling for Gmail, kept separate from server.py so the
credential flow can be reused/tested independently of the MCP tool
definitions.

First run: opens a browser for you to log in and grant Gmail access,
...
# We need modify and send scopes for Gmail
SCOPES = [
